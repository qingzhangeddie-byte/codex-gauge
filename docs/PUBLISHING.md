...
5. Create tag `v0.9.7` on the public clean-history commit.
...
- Create the GitHub Release for `v0.9.7`; the README release badge should not point at an older identity.
- Set GitHub About description: `Calm macOS menu bar gauge for live OpenAI Codex quota windows, reset countdowns, and local-only diagnostics`.
