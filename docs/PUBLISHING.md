...
4. Create tag `v0.4.0` on the public clean-history commit.
5. Sign and notarize with external credentials.
6. Publish a zipped app bundle or DMG.
7. Update the Homebrew cask checksum.
...
- Create the GitHub Release for `v0.4.0`; the README release badge should not point at an older identity.
