...
5. Create tag `v0.8.0` on the public clean-history commit.
...
- Create the GitHub Release for `v0.8.0`; the README release badge should not point at an older identity.
