...
class NativeCodexOnlyTests(unittest.TestCase):
    ...
    def test_native_app_draws_plan_b_four_bar_status_image(self):
        ...
        self.assertIn("statusImageSize = NSSize(width: 190, height: 22)", source)
        self.assertIn("resetRailWidth: CGFloat = 34", source)
        ...
        self.assertIn("NSRect(x: 122, y: y, width: resetRailWidth + 4, height: 3)", source)
        self.assertIn("NSPoint(x: 164, y: y - 3.2)", source)
