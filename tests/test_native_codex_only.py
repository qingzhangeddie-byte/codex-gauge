...
class NativeCodexOnlyTests(unittest.TestCase):
    ...
    def test_native_app_draws_codex_usage_in_native_status_view(self):
        ...
        self.assertIn("quotaRailSize = NSSize(width: 20, height: 5)", source)
        ...
        self.assertIn("let cornerRadius = min(1.5, rect.height / 2.0)", source)
        ...
        self.assertIn("NSColor(calibratedRed: 0.18, green: 0.56, blue: 0.96, alpha: 0.92)", source)
        self.assertIn("NSColor(calibratedRed: 0.58, green: 0.63, blue: 0.75, alpha: 0.98)", source)
        self.assertIn("NSColor(calibratedWhite: 1.0, alpha: 0.18)", source)
        self.assertIn("NSColor(calibratedWhite: 0.08, alpha: 0.16)", source)
