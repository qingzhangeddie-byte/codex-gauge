...
printf "  Startup launch is enabled with ~/Library/LaunchAgents/app.codexgauge.menubar.plist.\n"
printf "  No support-folder logs, quota caches, histories, reports, or saved refresh preferences are kept.\n"
